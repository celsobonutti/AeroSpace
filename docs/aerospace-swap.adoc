...
--move-mouse::
Move the mouse to the center of the focused window's new position after the swap.
Unlike chaining a separate `move-mouse` command, this accounts for the post-swap layout.
